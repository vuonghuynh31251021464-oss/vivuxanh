...
terrain = ctrl.Antecedent(np.arange(0, 10.1, 0.1), 'terrain')      # 0 = bằng phẳng, 10 = gồ ghề/dốc
...
if st.button("🚀 Tìm xe", type="primary"):
    ...
    final_price = int(final_price / 1000) * 1000   # Làm tròn như Grab
